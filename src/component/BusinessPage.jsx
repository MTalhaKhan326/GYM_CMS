...
const BusinessPage = () => {
  ...
  const [dataa, setData] = useState(
    blogData.filter((word) => word.area === formFields.search)
  );

  const onSubmit = async (e) => {
    e.preventDefault();
    console.log("search", formFields.search);
    setData(blogData.filter((word) => word.area === formFields.search));
  };
